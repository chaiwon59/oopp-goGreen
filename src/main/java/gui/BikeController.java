...
public class BikeController implements Initializable {
    ...
    @FXML
    private void loadTransportationScreen(ActionEvent event) throws IOException {
    ...
    @FXML
    private void bikeInsteadOfCar(ActionEvent event4) throws IOException {
        if (ClientServerCommunication.addTransportActivity(Main.user,
                Integer.parseInt(distanceField.getText()), "Bike",
