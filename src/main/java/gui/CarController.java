...
public class CarController implements Initializable {
    ...
    @FXML
    private void loadLogincreen(ActionEvent event3) throws IOException {
    ...
    @FXML
    private void carInsteadOfPlane(ActionEvent event) throws IOException {
        if (ClientServerCommunication.addTransportActivity(Main.user,
                Integer.parseInt(distanceField.getText()), "Car",
                "Plane", new Client(), new RestTemplate())) {
