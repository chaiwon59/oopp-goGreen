...
public class SolarController implements Initializable {
    ...
    @FXML
    private void addSolarPanelActivity(ActionEvent event) throws IOException {
        boolean result;
        result = ClientServerCommunication
                .addSolarPanelActivity(
                        Main.user, distanceField.getText(), new Client(), new RestTemplate());
